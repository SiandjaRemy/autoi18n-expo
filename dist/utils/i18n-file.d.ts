 ...
 */
export declare function resolveI18nFilePath(appRoot: string, config: RaiConfig): string;
/**
 ...
 */
export declare function generateInitialI18nFile(appRoot: string, config: RaiConfig): void;
/**
 ...
 */
export declare function addLocaleToI18nFile(appRoot: string, config: RaiConfig, newLanguage: string): void;
